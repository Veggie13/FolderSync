========================================================================
    ACTIVE TEMPLATE LIBRARY : FolderSync Project Overview
========================================================================

AppWizard has created this FolderSync project for you to use as the starting point for
...
FolderSync.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (FolderSync.h)
        GUID definitions                                (FolderSync_i.c)
        A type library                                  (FolderSync.tlb)
        Marshaling code                                 (FolderSync_p.c and dlldata.c)

FolderSync.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in FolderSync.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named FolderSync.pch and a precompiled types file named StdAfx.obj.
...
FolderSyncps.vcxproj
	...
	dlldata.c, FolderSync_i.c and FolderSync_p.c which are required
	to build the proxy/stub DLL.

FolderSyncps.vcxproj.filters
